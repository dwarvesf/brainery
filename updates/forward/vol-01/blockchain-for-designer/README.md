...
![A block contains data, its own hash, and the previous one’s hash](assets/block-data.png)

## How it works

![Credit to: Coinmama](assets/how-it-works.png)
