...
Voice AI on microcontrollers has been "almost ready" for years. XiaoZhi feels like the first open-source stack where the pieces actually fit: cheap hardware, offline wake words, streaming LLM inference, and a protocol (MCP) that lets the AI actually _do_ things. The 28k stars suggest a lot of people agree.
