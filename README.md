...
media). The full pre-squash history, every branch and the open-PR patches
of that day, live in `dwarvesf/brainery-archive` (private). `git blame`
beyond the squash date means checking the archive.
